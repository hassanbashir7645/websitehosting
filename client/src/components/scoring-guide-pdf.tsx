...
export function ScoringGuidePDFExport() {
  ...
  const generateScoringGuidePDF = async () => {
    ...
    try {
      ...
      pdf.text('Meeting Matters HR Management System', pageWidth / 2, yPosition, { align: 'center' });
      ...
      pdf.setFontSize(10);
      pdf.setFont('helvetica', 'italic');
      pdf.text('Meeting Matters HR Management System - Psychometric Assessment Guide', pageWidth / 2, yPosition, { align: 'center' });
